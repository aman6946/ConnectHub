...
function Home() {
  ...
  return (
    <div className="w-full min-h-[100vh] bg-[#f0efe7] pt-[100px] flex items-center lg:items-start justify-center gap-[20px] px-[20px] flex-col lg:flex-row relative pb-[50px]">
      ...
      {/* Modal Background */}
      {uploadPost && (
        <div className="w-full h-full bg-black fixed top-0 left-0 z-[100] opacity-[0.6]"></div>
      )}
      ...
      {uploadPost && (
        ...
        >
          ...
          {/* Image Preview */}
          {frontendImage && (
            <div className="w-full h-[200px] overflow-hidden flex justify-center items-center rounded-lg">
